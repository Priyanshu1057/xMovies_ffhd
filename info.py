...
START_IMG = environ.get('START_IMG', 'https://i.ibb.co/bMJrCftP/x.jpg https://i.ibb.co/0VywJtRC/x.jpg https://i.ibb.co/TBGC5z2Y/x.jpg https://i.ibb.co/hFGzcBrs/x.jpg https://i.ibb.co/XZ9RFNVy/x.jpg')
...
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://jhonwickp1:yRD1YhgiGPiziyyH@cluster0.towfdff.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
...
request_channel = environ.get('REQUEST_CHANNEL', '-1003086102817')
...
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002601777610').split()] # Auto Index Channel
DELETE_CHANNELS = int(environ.get('DELETE_CHANNELS','-1002756257415')) # Channel to delete file from DB
