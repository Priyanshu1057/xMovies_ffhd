...
FSUB_PICS = (environ.get('FSUB_PICS', 'https://files.catbox.moe/umt55e.jpg')).split() 
...
BIN_CHANNEL = environ.get("BIN_CHANNEL", "-1003061709031") # Channel Where Files sent For stream
